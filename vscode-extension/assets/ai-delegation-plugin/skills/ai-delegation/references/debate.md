...
## Output
- Human-readable transcript: a markdown file under the dashboard globalStorage path's `discussions/` directory.
- System logs and prepared prompts: under the dashboard globalStorage path's `sessions/<run-id>/` directory.
