...
This mode does not edit repository files. For local coding/file-write tasks, use `references/local-agentic-worker.md` and `scripts/dispatch/Invoke-DelegatedAgentTask.ps1`.
...
- The task requires any repository file write. Use Local Agentic Worker instead.
