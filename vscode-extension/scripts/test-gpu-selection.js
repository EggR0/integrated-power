...
const endpoint = process.env.INTEGRATED_POWER_LOCAL_ENDPOINT || "http://127.0.0.1:11434";
const output = execFileSync("powershell.exe", ["-NoProfile", "-ExecutionPolicy", "Bypass", "-File", script, "-TaskType", "coding", "-InstalledOnly", "-InstalledModels", "qwen3.6:27b", "-PreferredModel", "qwen3.6:27b", "-HardwareMode", "user_default", "-OllamaEndpoint", endpoint, "-AsJson"], { encoding: "utf8", env: { ...process.env, PATH: `${fakeBin};${process.env.PATH}` }, timeout: 30000 });
