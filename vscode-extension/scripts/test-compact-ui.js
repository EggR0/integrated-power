...
try {
  const html = readFile("control-center/index.html");
  const tauri = JSON.parse(readFile("control-center/src-tauri/tauri.conf.json"));
  const mainRs = readFile("control-center/src-tauri/src/main.rs");
