...
|------|-------|-----|--------|
| C:\Users\jsp0\Documents\Intergrated POWER\tests\agentic_loop_validation_command_e2e\target.ps1 | 1 | ALL | 19 | 

### File: C:\Users\jsp0\Documents\Intergrated POWER\tests\agentic_loop_validation_command_e2e\target.ps1
```powershell
$value = "old"
...
if ((Get-Content -LiteralPath 'C:\Users\jsp0\Documents\Intergrated POWER\tests\agentic_loop_validation_command_e2e\targ
et.ps1' -Raw) -match 'good') { exit 0 } else { Write-Error 'validation saw non-good content'; exit 1 } : validation saw
 non-good content
