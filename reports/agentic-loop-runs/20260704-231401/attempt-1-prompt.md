...
|------|-------|-----|--------|
| C:\Users\jsp0\Documents\Intergrated POWER\tests\agentic_loop_validation\korean.txt | 1 | ALL | 67 | 

### File: C:\Users\jsp0\Documents\Intergrated POWER\tests\agentic_loop_validation\korean.txt
```powershell
?덈뀞?섏꽭?? 濡쒖뺄 LLM 寃利??뚯씪?낅땲??
?곹깭: ?댁쟾
...
User Prompt:
korean.txt의 두 번째 줄 '상태: 이전'을 '상태: 이후'로 바꿔라. 한국어 텍스트를 깨뜨리지 마라. 반드시 SEARCH/REPLACE 형식만 출력하라.
