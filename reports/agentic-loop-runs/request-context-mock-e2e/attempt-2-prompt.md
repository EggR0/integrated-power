...
|------|-------|-----|--------|
| C:\Users\jsp0\Documents\Intergrated POWER\tests\request_context_e2e\main.ps1 | 1 | ALL | 37 |
| C:\Users\jsp0\Documents\Intergrated POWER\tests\request_context_e2e\moduleA.ps1 | 1 | ALL | 54 | 

### File: C:\Users\jsp0\Documents\Intergrated POWER\tests\request_context_e2e\main.ps1
```powershell
Write-Host "Hello Request Context"
```


### File: C:\Users\jsp0\Documents\Intergrated POWER\tests\request_context_e2e\moduleA.ps1
```powershell
function Get-ModuleAContext { "moduleA available" }
```


User Prompt:
Use moduleA context before changing the greeting.

=== PREVIOUS ATTEMPT FEEDBACK ===

Granted context for file: 'C:\Users\jsp0\Documents\Intergrated POWER\tests\request_context_e2e\moduleA.ps1' (Reason: need moduleA helper context before patching main.ps1).
